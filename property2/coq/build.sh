...
for f in HelloIris.v mp.v tlb_shootdown.v rmap_defer.v refcount_race.v pin_ledger.v swap_device.v batch_free.v stale_put.v quarantine.v floor_at_present.v; do
  printf '%-20s ' "$f"
