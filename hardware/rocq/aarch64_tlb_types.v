...
Record AaEntry := {
  AaEntry_vatag : bits 44;
  AaEntry_oabase : bits 44;
  AaEntry_tgx : TGx;
  AaEntry_level : Z;
  AaEntry_d128 : bool;
  AaEntry_contig : bool;
}.
Arguments AaEntry : clear implicits.
#[export]
Instance Decidable_eq_AaEntry : EqDecision AaEntry.
...
Defined.
#[export]
Instance Countable_AaEntry : Countable AaEntry.
refine {|
  encode x := encode (AaEntry_vatag x, AaEntry_oabase x, AaEntry_tgx x, AaEntry_level x, AaEntry_d128 x, AaEntry_contig x);
  decode x := '(x0, x1, x2, x3, x4, x5) ← decode x;
              mret (Build_AaEntry x0 x1 x2 x3 x4 x5)
|}.
abstract (
  intros [x0 x1 x2 x3 x4 x5];
...
Notation "{[ r 'with' 'AaEntry_vatag' := e ]}" :=
  match r with Build_AaEntry _ (_ as f1) (_ as f2) (_ as f3) (_ as f4) (_ as f5) =>
    Build_AaEntry e f1 f2 f3 f4 f5 end (at level 0).
Notation "{[ r 'with' 'AaEntry_oabase' := e ]}" :=
  match r with Build_AaEntry (_ as f0) _ (_ as f2) (_ as f3) (_ as f4) (_ as f5) =>
    Build_AaEntry f0 e f2 f3 f4 f5 end (at level 0).
Notation "{[ r 'with' 'AaEntry_tgx' := e ]}" :=
  match r with Build_AaEntry (_ as f0) (_ as f1) _ (_ as f3) (_ as f4) (_ as f5) =>
    Build_AaEntry f0 f1 e f3 f4 f5 end (at level 0).
Notation "{[ r 'with' 'AaEntry_level' := e ]}" :=
  match r with Build_AaEntry (_ as f0) (_ as f1) (_ as f2) _ (_ as f4) (_ as f5) =>
    Build_AaEntry f0 f1 f2 e f4 f5 end (at level 0).
Notation "{[ r 'with' 'AaEntry_d128' := e ]}" :=
  match r with Build_AaEntry (_ as f0) (_ as f1) (_ as f2) (_ as f3) _ (_ as f5) =>
    Build_AaEntry f0 f1 f2 f3 e f5 end (at level 0).
Notation "{[ r 'with' 'AaEntry_contig' := e ]}" :=
  match r with Build_AaEntry (_ as f0) (_ as f1) (_ as f2) (_ as f3) (_ as f4) _ =>
    Build_AaEntry f0 f1 f2 f3 f4 e end (at level 0).
#[export]
Instance dummy_AaEntry : Inhabited (AaEntry) := {
  inhabitant := {|
    AaEntry_vatag := inhabitant;
    AaEntry_oabase := inhabitant;
    AaEntry_tgx := inhabitant;
    AaEntry_level := inhabitant;
    AaEntry_d128 := inhabitant;
    AaEntry_contig := inhabitant
|} }.
